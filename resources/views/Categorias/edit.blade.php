    ...
    <card class="border-2 border-gray-300 rounded-2xl p-5 w-96">
      ...
      <input name="nombre" type="text"  placeholder="Nombre del Producto"
         class="flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400
          text-gray-600 placeholder-gray-400 outline-none" value="{{$categoria->nombre}}">
                                
      <button type="submit" class="bg-green-400 delay-75 duration-100 text-white text-sm font-bold rounded-2xl w-full py-3 mt-7 border-b-4 border-b-green-600">Creacion de categoria</button>
    </card>
  </div>
        </form>
